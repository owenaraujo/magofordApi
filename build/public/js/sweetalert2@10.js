...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e();
}(void 0, function () {
  "use strict";
  ...
  function Rt(t, c) {
    ...
    l >= c.progressSteps.length && K("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), c.progressSteps.forEach(function (t, e) {
      var n,
          ...
          r,
          a,
          s = (n = t, o = document.createElement("li"), vt(o, J["progress-step"]), _(o, n), o);
  ...
  function ne(t) {
    for (var e in t) {
      te(i = e) || K('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== se.indexOf(o) && K('The parameter "'.concat(o, '" is incompatible with toasts'))), ee(n = e) && g(n, ee(n));
    }
  ...
  }), yn.DismissReason = $, yn.version = "10.3.5";
  var bn = yn;
