...
/*!
  ...
  */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) && "undefined" != typeof module ? e(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], e) : e((t = t || self).bootstrap = {}, t.jQuery);
}(void 0, function (t, e) {
  "use strict";
    ...
    return n.next = function () {
      ...
      return this.each(function () {
        var i = e(this).data("bs.carousel"),
            o = s(s({}, v), e(this).data());
        "object" == (0, _typeof2["default"])(n) && (o = s(s({}, o), n));
    ...
    return n.toggle = function () {
      ...
      return this.each(function () {
        var i = e(this),
            ...
            r = s(s(s({}, T), i.data()), "object" == (0, _typeof2["default"])(n) && n ? n : {});
  ...
  var It = "dropdown",
    ...
    return n.toggle = function () {
      ...
      return this.each(function () {
        ...
        if (i || (i = new t(this, "object" == (0, _typeof2["default"])(n) ? n : null), e(this).data("bs.dropdown", i)), "string" == typeof n) {
    ...
    return n.toggle = function (t) {
      ...
      return this.each(function () {
        var o = e(this).data("bs.modal"),
            r = s(s(s({}, Mt), e(this).data()), "object" == (0, _typeof2["default"])(n) && n ? n : {});
  ...
  var Yt = "tooltip",
    ...
    return n.enable = function () {
      ...
      "object" != (0, _typeof2["default"])(n) || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = Vt(n, this.config.whiteList, this.config.sanitizeFn)), t.html(n)) : t.text(n) : this.config.html ? e(n).parent().is(t) || t.empty().append(n) : t.text(e(n).text());
    }, n.getTitle = function () {
      ...
      }), "number" == typeof (t = s(s(s({}, this.constructor.Default), n), "object" == (0, _typeof2["default"])(t) && t ? t : {})).delay && (t.delay = {
        show: t.delay,
        hide: t.delay
      ...
      return this.each(function () {
        var i = e(this).data("bs.tooltip"),
            o = "object" == (0, _typeof2["default"])(n) && n;
    ...
    return s.isWithContent = function () {
      ...
      return this.each(function () {
        var n = e(this).data("bs.popover"),
            i = "object" == (0, _typeof2["default"])(t) ? t : null;
  ...
  var le = "scrollspy",
    ...
    return n.refresh = function () {
      ...
      if ("string" != typeof (t = s(s({}, ue), "object" == (0, _typeof2["default"])(t) && t ? t : {})).target && l.isElement(t.target)) {
      ...
      return this.each(function () {
        ...
        if (i || (i = new t(this, "object" == (0, _typeof2["default"])(n) && n), e(this).data("bs.scrollspy", i)), "string" == typeof n) {
          if ("undefined" == typeof i[n]) throw new TypeError('No method named "' + n + '"');
          i[n]();
        }
      });
  ...
  var me = e.fn.toast,
    ...
    return n.show = function () {
      ...
      return t = s(s(s({}, ve), e(this._element).data()), "object" == (0, _typeof2["default"])(t) && t ? t : {}), l.typeCheckConfig("toast", t, this.constructor.DefaultType), t;
    }, n._setListeners = function () {
      var t = this;
      ...
      return this.each(function () {
        ...
        if (o || (o = new t(this, "object" == (0, _typeof2["default"])(n) && n), i.data("bs.toast", o)), "string" == typeof n) {
          if ("undefined" == typeof o[n]) throw new TypeError('No method named "' + n + '"');
          o[n](this);
        }
      });
